          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-slate-50 text-slate-900 font-medium px-4 py-3 rounded-xl text-sm border border-slate-300 focus:outline-none focus:ring-2 focus:ring-amber-500"
              >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-white text-slate-900 font-medium px-4 py-2.5 rounded-xl text-sm border border-slate-300 focus:outline-none focus:ring-2 focus:ring-amber-500"
              />
            </div>
