    ...
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-md flex justify-end">
      <div className="bg-white border-l border-slate-200 w-full max-w-xl h-full overflow-y-auto p-6 space-y-6 shadow-2xl flex flex-col justify-between animate-in slide-in-from-right duration-300 text-slate-900">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-300/80 rounded-2xl p-4 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-amber-700" />
                <span className="text-xs font-black text-amber-900">Active Destination Email</span>
              </div>
              <span className="text-xs font-mono bg-white px-2.5 py-0.5 rounded border border-amber-300 font-bold text-amber-900">
                {OWNER_GMAIL}
              </span>
            </div>
            ...
            <form onSubmit={handleSaveWebhook} className="space-y-2 pt-2 border-t border-amber-200/80">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-[10px] text-amber-800 underline font-extrabold flex items-center gap-1 cursor-pointer"
                >
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-white text-slate-900 text-xs px-3 py-2 rounded-xl border border-amber-300 focus:outline-none focus:ring-2 focus:ring-amber-500 font-mono"
                />
                <button
                  type="submit"
                  className="bg-amber-500 hover:bg-amber-600 text-slate-950 px-3 py-2 rounded-xl text-xs font-black shrink-0 transition-colors cursor-pointer"
                >
