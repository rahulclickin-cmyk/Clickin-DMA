    ...
    <section className="bg-white text-slate-900 py-16 px-4 md:px-8 border-b border-amber-200/80">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="bg-slate-50 border border-amber-300 rounded-2xl p-6 md:p-8 shadow-sm">
          {submitted ? (
            <div className="bg-amber-100/80 border border-amber-300 rounded-xl p-8 text-center space-y-4">
              <div className="w-14 h-14 bg-amber-500 text-slate-950 rounded-full flex items-center justify-center mx-auto text-2xl font-bold">
                ✓
              </div>
              <h3 className="text-xl font-bold text-amber-900">Your Discount Claimed!</h3>
              ...
              <button
                ...
                className="text-xs text-amber-800 underline font-semibold pt-2 cursor-pointer"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white text-slate-900 font-medium px-4 py-3 rounded-lg text-sm border border-slate-300 focus:outline-none focus:ring-2 focus:ring-amber-500"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="w-full bg-white text-slate-900 font-medium pl-18 pr-4 py-3 rounded-lg text-sm border border-slate-300 focus:outline-none focus:ring-2 focus:ring-amber-500"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-white text-slate-900 font-medium px-4 py-2.5 rounded-lg text-sm border border-slate-300 focus:outline-none focus:ring-2 focus:ring-amber-500"
                />
              </div>
