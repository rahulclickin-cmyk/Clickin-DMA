    ...
    <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-200">
      <div className="bg-white border border-slate-200 rounded-3xl max-w-md w-full p-6 sm:p-8 space-y-6 shadow-2xl relative text-slate-900">
        ...
        <div className="text-center space-y-2">
          <div className="w-14 h-14 mx-auto rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-600 flex items-center justify-center shadow-inner">
          ...
          <form onSubmit={handleVerify} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-extrabold text-slate-800 flex items-center justify-between">
                ...
                <span className="text-[10px] text-amber-700 font-normal">Default: 88822</span>
              </label>
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-300 rounded-xl px-4 py-3 text-sm font-mono tracking-widest text-slate-900 focus:outline-none focus:ring-2 focus:ring-amber-500 pr-10 shadow-inner"
                />
                <button
                  type="button"
            ...
            <div className="pt-2 text-center">
              <button
                ...
                className="text-xs text-amber-800 hover:text-amber-900 underline font-bold inline-flex items-center gap-1 cursor-pointer"
              >
          ...
          <form onSubmit={handleChangePasscodeSubmit} className="space-y-4">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-300 rounded-xl px-4 py-2.5 text-xs text-slate-900 focus:outline-none focus:ring-2 focus:ring-amber-500 font-mono"
              />
            </div>
            ...
            <div className="flex gap-2 pt-2">
              <button
                type="submit"
                className="flex-1 bg-amber-500 hover:bg-amber-600 text-slate-950 font-black py-2.5 rounded-xl text-xs shadow-md transition-colors cursor-pointer"
              >
                Save New Passcode
              </button>
              <button
