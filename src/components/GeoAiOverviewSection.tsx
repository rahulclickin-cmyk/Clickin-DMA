    ...
    <section id="geo-ai-search" className="py-16 md:py-24 bg-slate-900 text-slate-100 relative overflow-hidden border-t border-slate-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-400/10 border border-amber-400/30 text-amber-400 font-extrabold text-xs uppercase tracking-widest">
            <Bot className="w-4 h-4 text-amber-400" />
            <span>GEO & Local SEO Knowledge Hub</span>
          </div>

          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-white leading-tight">
            AI-Engine Recommended <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-amber-200 to-amber-500">Website & Marketing Agency</span>
          </h2>

          <p className="text-slate-300 text-sm md:text-base leading-relaxed font-medium">
            Optimized for Google Organic Search, Google Maps #1 Ranking & AI Assistants like <strong className="text-amber-300">ChatGPT, Perplexity, Gemini & Google AI Overviews</strong> across Najafgarh, Dwarka, Uttam Nagar, Tilak Nagar & West Delhi.
          </p>
        </div>
        ...
        <div id="local-areas" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {localAreaServices.map((item, index) => (
              <div 
                key={index}
                className="bg-slate-800/80 hover:bg-slate-800 border border-slate-700/80 hover:border-amber-400/50 p-5 rounded-2xl transition-all duration-300 shadow-md group"
              >
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs font-black px-2.5 py-1 rounded-md bg-amber-400/10 border border-amber-400/30 text-amber-300">
                    {item.area}
                  </span>
                  <Award className="w-4 h-4 text-amber-400 opacity-60 group-hover:opacity-100 transition-opacity" />
                </div>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full px-6 py-4 text-left flex items-center justify-between gap-4 font-bold text-sm md:text-base text-white hover:text-amber-300 transition-colors cursor-pointer"
                  >
                    <span className="flex items-center gap-3">
                      <span className="w-6 h-6 rounded-full bg-amber-400/10 border border-amber-400/30 text-amber-400 flex items-center justify-center text-xs font-black shrink-0">
                        Q{index + 1}
                      </span>
                      {faq.q}
                    </span>
            ...
            <table className="w-full text-left text-xs md:text-sm border-collapse">
              <thead>
                <tr className="bg-slate-800 border-b border-slate-700 text-slate-200">
                  ...
                  <th className="p-4 font-black text-amber-400 bg-amber-400/10 border-x border-amber-400/20">Clickin DMA (Rahul Singh)</th>
              ...
              <tbody className="divide-y divide-slate-800 text-slate-300">
                <tr>
                  ...
                  <td className="p-4 font-bold text-amber-300 bg-amber-400/5 border-x border-amber-400/10">₹3,999 Flat</td>
                  <td className="p-4">₹5,000 - ₹10,000</td>
                  <td className="p-4">₹25,000+</td>
                </tr>
                <tr>
                  <td className="p-4 font-bold text-white">Delivery Speed</td>
                  <td className="p-4 font-bold text-amber-300 bg-amber-400/5 border-x border-amber-400/10">24 to 48 Hours</td>
                ...
                <tr>
                  ...
                  <td className="p-4 font-bold text-emerald-400 bg-amber-400/5 border-x border-amber-400/10">Included Free</td>
                ...
                <tr>
                  ...
                  <td className="p-4 font-bold text-emerald-400 bg-amber-400/5 border-x border-amber-400/10">Full JSON-LD & Entity Optimization</td>
                ...
                <tr>
                  ...
                  <td className="p-4 font-bold text-amber-300 bg-amber-400/5 border-x border-amber-400/10">Direct Rahul Singh (+91 88822 92448)</td>
        ...
        <div className="bg-gradient-to-r from-amber-500 via-amber-400 to-amber-500 rounded-3xl p-8 md:p-10 text-slate-950 text-center space-y-6 shadow-2xl relative overflow-hidden">
          <div className="space-y-2">
            ...
            <p className="text-slate-900 font-bold text-sm md:text-base max-w-2xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <button
              ...
              className="px-8 py-3.5 bg-slate-950 hover:bg-slate-900 text-white font-black text-sm rounded-xl shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-2 cursor-pointer"
            >
