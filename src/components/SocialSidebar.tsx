  ...
  return (
    <aside className="fixed left-0 top-1/2 -translate-y-1/2 z-40 hidden lg:flex flex-col gap-2.5 bg-white/90 backdrop-blur-md p-2 rounded-r-2xl border-y border-r border-slate-200 shadow-xl">
      ...
      >
        ...
        <span className="absolute left-12 top-1/2 -translate-y-1/2 bg-slate-900 text-white text-xs font-semibold px-2.5 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap shadow-lg border border-amber-400">
          Instagram
        </span>
      </a>
